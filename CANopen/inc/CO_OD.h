...
/*******************************************************************************
   FILE INFO:
      FileName:     BMS
      FileVersion:  1.0
      CreationTime: 01:01:55
      CreationDate: 2014-12-09
      CreatedBy:    -
*******************************************************************************/
...
/*******************************************************************************
   DEVICE INFO:
      VendorName:     WalkingMachine
      VendorNumber:   1
      ProductName:    BatteryManagementSystem
      ProductNumber:  1
*******************************************************************************/
...
/*2108      */ INTEGER16      batteryTemperature;
/*2109      */ INTEGER16      batteryVoltage;
/*2110      */ INTEGER8       batteryHealth;
/*2111      */ INTEGER8       batteryStatus;
/*2112      */ INTEGER16      cellVoltage[6];
/*2120      */ INTEGER8       cellHealth[6];
/*2121      */ INTEGER8       cellStatus[6];
...
/*2108, Data Type: INTEGER16 */
      #define OD_batteryTemperature                      CO_OD_RAM.batteryTemperature

/*2109, Data Type: INTEGER16 */
      #define OD_batteryVoltage                          CO_OD_RAM.batteryVoltage

/*2110, Data Type: INTEGER8 */
      #define OD_batteryHealth                           CO_OD_RAM.batteryHealth

/*2111, Data Type: INTEGER8 */
      #define OD_batteryStatus                           CO_OD_RAM.batteryStatus

/*2112, Data Type: INTEGER16, Array[6] */
      #define OD_cellVoltage                             CO_OD_RAM.cellVoltage
      #define ODL_cellVoltage_arrayLength                6
...
/*2120, Data Type: INTEGER8, Array[6] */
      #define OD_cellHealth                              CO_OD_RAM.cellHealth
      #define ODL_cellHealth_arrayLength                 6
      #define ODA_cellHealth_cell1                       0
      #define ODA_cellHealth_cell2                       1
      #define ODA_cellHealth_cell3                       2
      #define ODA_cellHealth_cell4                       3
      #define ODA_cellHealth_cell5                       4
      #define ODA_cellHealth_cell6                       5

/*2121, Data Type: INTEGER8, Array[6] */
      #define OD_cellStatus                              CO_OD_RAM.cellStatus
      #define ODL_cellStatus_arrayLength                 6
      #define ODA_cellStatus_cell1                       0
      #define ODA_cellStatus_cell2                       1
      #define ODA_cellStatus_cell3                       2
      #define ODA_cellStatus_cell4                       3
      #define ODA_cellStatus_cell5                       4
      #define ODA_cellStatus_cell6                       5
